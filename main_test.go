...
var game0cases = [][]gameCase{
	[]gameCase{
		...
		{5, "осмотреться", "на столе: ключи, конспекты. можно пройти - коридор"},
		{6, "взять ключи", "предмет добавлен в инвентарь: ключи"}, // действие взять
		{6, "осмотреться", "на столе: конспекты. можно пройти - коридор"},
		...
		{12, "идти домой", "ничего интересного. можно пройти - кухня, комната, улица"},
	},
...
func TestGame0(t *testing.T) {
	for caseNum, commands := range game0cases {
		...
		for _, item := range commands {
			...
			fmt.Println(caseNum, item.command, "____ RESPONSE:", answer)
